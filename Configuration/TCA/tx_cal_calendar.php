...
$tx_cal_calendar = array (
    ...
    'types' => array (
        ...
        '0' => array (
            ...
            'showitem' => 'type,title, --palette--;;1,owner,activate_fnb,fnb_user_cnt,nearby'
        ),
        '1' => array (
            
            'showitem' => 'type,title, --palette--;;1,owner,activate_fnb,fnb_user_cnt,nearby,ext_url,refresh,schedulerId'
        ),
        '2' => array (
            
            'showitem' => 'type,title, --palette--;;1,owner,activate_fnb,fnb_user_cnt,nearby,ics_file,refresh,schedulerId'
        )
    ),
    'palettes' => array (
