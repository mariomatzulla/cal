...
class FormDataPreprocessorSlot {
  ...
  public static function register() {
    ...
    \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance( \TYPO3\CMS\Extbase\SignalSlot\Dispatcher::class )->connect( \TYPO3\CMS\Backend\Form\DataPreprocessor::class, 'fetchRecordPostProcessing', \TYPO3\CMS\Cal\Slot\FormDataPreprocessorSlot::class, 'fetchCalRecordPostProcessing' );
  }
