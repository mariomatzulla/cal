...
class CustomTca {
  ...
  public function init($PA, $fobj) {
    ...
    $this->commonJS = '';
    $this->commonJS .= '<script src="' . \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath( 'cal' ) . 'Resources/Public/js/recurui3.js" type="text/javascript"></script>' . chr( 10 ) . '<script src="' . \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath( 'cal' ) . 'Resources/Public/js/url2.js" type="text/javascript"></script>';
