...
class TceFuncSelectTreeView extends \TYPO3\CMS\Backend\Tree\View\AbstractTreeView {
  ...
  public function getRootIcon($rec) {
    ...
    return $this->wrapIcon( '<img src="' . \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath( 'cal' ) . 'res/icons/icon_tx_cal_calendar.gif" width="18" height="16" alt="" />', array () );
  }
}
