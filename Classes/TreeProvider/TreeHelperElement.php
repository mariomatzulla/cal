...
class TreeHelperElement extends \TYPO3\CMS\Backend\Form\Element\AbstractFormElement {
   ...
   * @param string $field
   *          The field name which this element is supposed to edit
   * @param array $row
   *          The record data array where the value(s) for the field can be found
   * @param array $additionalInformation
   *          An array with additional configuration options.
