...
class Cache {
  ...
  function initCachingFramework() {
    ...
    try {
      $GLOBALS ['typo3CacheFactory']->create( 'tx_cal_cache', 'TYPO3\\CMS\\Core\\Cache\\Frontend\\VariableFrontend', $GLOBALS ['TYPO3_CONF_VARS'] ['SYS'] ['caching'] ['cacheConfigurations'] ['tx_cal_cache'] ['backend'], $GLOBALS ['TYPO3_CONF_VARS'] ['SYS'] ['caching'] ['cacheConfigurations'] ['tx_cal_cache'] ['options'] );
