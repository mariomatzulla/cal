...
$boot = function () {
  ...
  // Page module hook
  $GLOBALS ['TYPO3_CONF_VARS'] ['SC_OPTIONS'] ['cms/layout/class.tx_cms_layout.php'] ['list_type_Info'] ['cal' . '_controller'] ['cal'] = \TYPO3\CMS\Cal\Hooks\PageLayoutView::class . '->getExtensionSummary';
  
  \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig( '
    <INCLUDE_TYPOSCRIPT: source="FILE:EXT:cal/Configuration/TSconfig/ContentElementWizard.txt">
  ' );
  ...
  if (! isset( $GLOBALS ['TYPO3_CONF_VARS'] ['SYS'] ['caching'] ['cacheConfigurations'] ['tx_cal_cache'] ['frontend'] )) {
    $GLOBALS ['TYPO3_CONF_VARS'] ['SYS'] ['caching'] ['cacheConfigurations'] ['tx_cal_cache'] ['frontend'] = 'TYPO3\\CMS\\Core\\Cache\\Frontend\\VariableFrontend';
  }
  ...
  if (TYPO3_MODE === 'BE') {
    $icons = [ 
        ...
        'ext-cal-wizard-icon' => 'ce_wiz.gif'
    ];
    ...
    foreach ( $icons as $identifier => $path ) {
      if (! $iconRegistry->isRegistered( $identifier )) {
        $iconRegistry->registerIcon( $identifier, \TYPO3\CMS\Core\Imaging\IconProvider\BitmapIconProvider::class, [ 
            ...
            'source' => 'EXT:cal/Resources/Public/icons/' . $path
        ] );
      }
    }
  }
